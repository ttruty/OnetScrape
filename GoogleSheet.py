...
SAMPLE_SPREADSHEET_ID = '1l2aL3pliJWK8I3Nq3fri3zQdjQZQtGaHY5lSeFLo5aQ'
SAMPLE_RANGE_NAME = 'Rapid Growth!A5:A393'
...
def main():
    ...
    if not values:
        ...
        for row in values:
            ...
            #print(row[0])
            request = 'mnm/careers/' + row[0] + '/job_outlook'
            kwresults = onet_ws.call(request)
            ...
            #     print("")
            try:
                print(kwresults['salary']['annual_90th_percentile'])
            except:
